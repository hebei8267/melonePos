 ...
 */
@Entity
@Table(name = "T_SALES_WEEK_TOTAL_GOODS_3")
// 默认的缓存策略.
// @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class SalesWeekTotalGoods_3 extends IdEntity {

	private static final long serialVersionUID = 2084463046162114646L;
	/** 机构编号 */
