 ...
 */
@Entity
@Table(name = "T_SALES_WEEK_TOTAL_GOODS_4")
// 默认的缓存策略.
// @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class SalesWeekTotalGoods_4 extends IdEntity {

	private static final long serialVersionUID = 5691369348597711096L;
	/** 机构编号 */
