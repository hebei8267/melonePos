 ...
 * 提供了各种convert方法，适合不同的i18n需求: 1. message 2. propertyPath + separator + message
 * 
...
public class BeanValidators {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static List<String> extractPropertyAndMessage(Set<? extends ConstraintViolation> constraintViolations, String separator) {
		List<String> errorMessages = Lists.newArrayList();
		for (ConstraintViolation violation : constraintViolations) {
