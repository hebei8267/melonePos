	...
	<body>
		...
		<div class="container">
            <div class="row">
                <div class="span12">
                    <legend>
                        <h3>${sessionScope.__SESSION_USER_INFO.orgName} 顾客/会员预付款<span class="_warn1">(充值)</span>信息
                ...
                <div class="span12"	style="margin-top: 10px;">
                    <form:form method="POST" class="form-horizontal" id="inputForm"	modelAttribute="prePayments">
                        <%//使用方式(1充值、2消费) %>
                        <input id="inOutFlg" name="inOutFlg" type="hidden" value="1"/>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                          		<select id="rechargeWay" name="rechargeWay" class="input-medium">
                          			<option value=""></option>
