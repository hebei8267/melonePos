                        ...
                        <table class="table	table-striped table-bordered table-condensed mytable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="center">
                                        当班销售额<br>(普通 / 支付宝 / 微信 / 金卡[消费/返利] / 代金卷)
                                    </th>
                                    <th class="center">
                                        商场汇报<br>销售额
                                    </th>
                            ...
                            <tbody>
                                <c:forEach items="${cashRunList}" var="cashRun">
                                    <tr>
                                        ...
                                        <td class="center">
                                            ${cashRun.saleAmt} / ${cashRun.zfbSaleAmt} / ${cashRun.wxSaleAmt} / ${cashRun.goldCardAmt} / ${cashRun.rebateAmt} / ${cashRun.totalCouponValue} <br>(${cashRun.saleAmt + cashRun.zfbSaleAmt + cashRun.wxSaleAmt + cashRun.goldCardAmt + cashRun.rebateAmt + cashRun.totalCouponValue})
                                        </td>
                                        <td>
                                            ${cashRun.reportAmt}
                                        </td>
                                ...
                                <c:if test="${!empty cashRunList}" >
                                    <tr>
                                        ...
                                        <td></td>
                                        <td class="center">
                                            ${totalCashRun.saleAmt} / ${totalCashRun.zfbSaleAmt} / ${totalCashRun.wxSaleAmt} / ${totalCashRun.goldCardAmt} / ${totalCashRun.rebateAmt} / ${totalCashRun.totalCouponValue}<br>(${totalCashRun.saleAmt + totalCashRun.zfbSaleAmt + totalCashRun.wxSaleAmt + totalCashRun.goldCardAmt + totalCashRun.rebateAmt + totalCashRun.totalCouponValue})
                                        </td>
                                        <td colspan="2">
