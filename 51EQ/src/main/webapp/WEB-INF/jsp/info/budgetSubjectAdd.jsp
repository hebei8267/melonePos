			...
			<div class="row">
				...
				<div class="span12">
					<div class="control-group">
						<label class="control-label">上层预算科目<span class="required">※</span></label>
						<div class="controls">
...
<script>
	function budgetSubjectAdd(form) {
		$.post('${sc_ctx}/budgetSubject/save', $('#budgetSubject-add-form').serialize(), function(result) {
			if (result) {
				form.submit();
			} else {
			}
	...
	$(function() {
		$("#budgetSubject-add-form").validate({
			rules : {
				parentSubUuid : {
					required : true
				},
