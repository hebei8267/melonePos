...
<html>
    <head>
    <script>	 	
	 	function detail_list(supplierBwId){
	 		$("#supplierBwId").val(supplierBwId);
            	
         	$("#listForm").attr("target", "_blank");
          	$("#listForm").attr("action", "${sc_ctx}/salesDaySupChartReport/org_goods_list");
         	$("#listForm").submit();
	 	}
 	</script>
    </head>
    <body>
        ...
        <div class="container">
        	<form method="post"	class="form-inline" id="listForm">
            	...
            	<input type="hidden" name="supplierBwId" id="supplierBwId" value="${optDateEnd}"/>
            	<div class="row">
                    <div class="span12">
                        <legend>
                            <h3>${orgName} 货商销售信息</h3>
                        </legend>
                    </div>
                            ...
                            <tbody>
                            	...
                            	<tr>
                                 	<td class="center">
                                  	...
                                  	<td class="center">
                                    	<a href="#" onclick="detail_list('${sumSaleRamt.supplierBwId}');" class="btn btn-warning"/>明细排名</a>
                                  	</td>
                              	</tr>
                            	</c:forEach>
                            </tbody>
