...
//		// 物件借还
//		// ---------------------------------------------
//		Permission perm57 = new Permission();
//		Function fun57 = functionJpaDao.findOne(57);
//		perm57.setRole(role);
//		perm57.setFunction(fun57);
//		permissionJpaDao.save(perm57);
//		
//		// ---------------------------------------------
//		// 人事管理
//		// ---------------------------------------------
//		Permission perm58 = new Permission();
//		Function fun58 = functionJpaDao.findOne(58);
//		perm58.setRole(role);
//		perm58.setFunction(fun58);
//		permissionJpaDao.save(perm58);
//		
//		
//		// ---------------------------------------------
//		// 角色管理
//		// ---------------------------------------------
//		Permission perm59 = new Permission();
//		Function fun59 = functionJpaDao.findOne(59);
//		perm59.setRole(role);
//		perm59.setFunction(fun59);
//		permissionJpaDao.save(perm59);
//		
//		
//		// ---------------------------------------------
//		// 预算科目管理
//		// ---------------------------------------------
//		Permission perm64 = new Permission();
//		Function fun64 = functionJpaDao.findOne(64);
//		perm64.setRole(role);
//		perm64.setFunction(fun64);
//		permissionJpaDao.save(perm64);
//		
//		// ---------------------------------------------
//		// 商品收发错添信息
//		// ---------------------------------------------
//		Permission perm68 = new Permission();
//		Function fun68 = functionJpaDao.findOne(68);
//		perm68.setRole(role);
//		perm68.setFunction(fun68);
//		permissionJpaDao.save(perm68);
//	}
//
//	// 总部人员-会计
//	@Test
...
//		permissionJpaDao.save(perm58);
		...
		// 机构合同管理
		// ---------------------------------------------
		Permission perm74 = new Permission();
		Function fun74 = functionJpaDao.findOne(74);
		perm74.setRole(role);
		perm74.setFunction(fun74);
		permissionJpaDao.save(perm74);
	}
	...
	@Test
	@Rollback(false)
	public void saveNewPerm9() {

		Role role = roleJpaDao.findOne(9);
