...
<div class="copyright">2013-2014 &copy; 武汉天径恒信科技有限公司.</div>
      
<!--[if lt IE 9]>
<script src="${ctx}/static/plugins/respond.min.js"></script>
<script src="${ctx}/static/plugins/excanvas.min.js"></script>
<![endif]-->
<script src="${ctx}/static/plugins/jquery-1.10.2.min.js" type="text/javascript"></script>
<script src="${ctx}/static/plugins/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>
<script src="${ctx}/static/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="${ctx}/static/plugins/bootstrap-hover-dropdown/twitter-bootstrap-hover-dropdown.min.js" type="text/javascript" ></script>
...
<script src="${ctx}/static/plugins/jquery.cookie.min.js" type="text/javascript"></script>
